...
namespace MathematicalEntities {
    ...
    public class Quad3f {
        ...
        public Quad3f(float x0, float y0, float z0, float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3) {
        ...
        public Quad3f(float x0, float y0, float x1, float y1, float x2, float y2, float x3, float y3) {
        ...
        public Quad3f(Vec2f v0, Vec2f v1, Vec2f v2, Vec2f v3) {
        ...
        public Quad3f(Vec3f v0, Vec3f v1, Vec3f v2, Vec3f v3) {
        ...
        public Quad3f(Vec4f v0, Vec4f v1, Vec4f v2, Vec4f v3) {
        ...
        public Triangle3f toTriangle1() {
            return new Triangle3f(v0, v1, v2);
        }

        public Triangle3f toTriangle2() {
            return new Triangle3f(v0, v2, v3);
        }
