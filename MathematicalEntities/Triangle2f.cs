...
namespace MathematicalEntities {
    public class Triangle2f {
        ...
        public Triangle2f(float x0, float y0, float x1, float y1, float x2, float y2) {
        ...
        public Triangle2f(Vec2f v0, Vec2f v1, Vec2f v2) {
        ...
        public Triangle2f(Vec3f v0, Vec3f v1, Vec3f v2) {
        ...
        public Triangle2f reClock() {

            return new Triangle2f(v0, v2, v1);
        }
        ...
        public Triangle2f reSort() {
            Triangle2f result = new Triangle2f(this);
            result.sort();
            return result;
        }
