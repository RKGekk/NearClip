...
namespace MathematicalEntities {
    ...
    public class Triangle3f {
        ...
        public Triangle3f(float x0, float y0, float z0, float x1, float y1, float z1, float x2, float y2, float z2) {
        ...
        public Triangle3f(float x0, float y0, float x1, float y1, float x2, float y2) {
        ...
        public Triangle3f(Triangle3f other) {
        ...
        public Triangle3f(Vec2f v0, Vec2f v1, Vec2f v2) {
        ...
        public Triangle3f(Vec4f v0, Vec4f v1, Vec4f v2) {
        ...
        public Triangle3f reClock() {

            return new Triangle3f(v0, v2, v1);
        }
        ...
        public Triangle3f reSort() {
            Triangle3f result = new Triangle3f(this);
            result.sort();
            return result;
        }
